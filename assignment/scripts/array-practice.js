...
favoriteFoods[1] = 'carbs';
console.log('updated favorite foods are:', favoriteFoods)

// 4.f (STRETCH) TODO: Sort your favoriteFoods array
//     in reverse alphabetical order. Log the array.
favoriteFoods.sort();
console.log('Favorite foods alphabetical order,', favoriteFoods)
favoriteFoods.reverse();
console.log('Favorite foods order is now,', favoriteFoods)
...
console.log('favorite foods are:', text)
...
console.log('The newArray created is:', newArray)